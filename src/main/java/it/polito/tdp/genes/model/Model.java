...
public class Model {
	...
	SimpleDirectedWeightedGraph<Integer, DefaultWeightedEdge> grafo;
	List<Integer> cromosomi;
	GenesDao dao;;
...
private List<Integer> best;
	...
	public void creaGrafo() {
		...
		this.cromosomi=dao.getChromosome();
		Graphs.addAllVertices(this.grafo, this.cromosomi);
		
		// aggiungo gli archi e il peso
		
		for (Adiacenza a : dao.getAdiacenze()) {
			if(this.grafo.getEdge(a.getCromosoma1(), a.getCromosoma2())== null) {
				Graphs.addEdgeWithVertices(grafo, a.getCromosoma1(), a.getCromosoma2(), a.getPeso());
			}
		}
